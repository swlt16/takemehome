...
grep -q 'id="scooter-toggle" type="checkbox"' "$project_dir/index.htm"
grep -q 'includeScooters: false' "$project_dir/assets/app.js"
grep -q 'routeRequestId: 0' "$project_dir/assets/app.js"
grep -q 'const includeScooters = state.includeScooters' "$project_dir/assets/app.js"
grep -q 'directModes: includeScooters ? "RENTAL" : ""' "$project_dir/assets/app.js"
grep -q 'directRentalFormFactors", "SCOOTER_STANDING"' "$project_dir/assets/app.js"
grep -q 'directRentalPropulsionTypes", "ELECTRIC"' "$project_dir/assets/app.js"
grep -q '...(data.direct || \[\])' "$project_dir/assets/app.js"
grep -q 'leg.mode === "RENTAL"' "$project_dir/assets/app.js"
grep -q 'function rentalMapMarkup' "$project_dir/assets/app.js"
grep -q 'leg?.from?.lat' "$project_dir/assets/app.js"
grep -q 'openstreetmap.org/export/embed.html' "$project_dir/assets/app.js"
grep -q 'Route & Karte ansehen' "$project_dir/assets/app.js"
grep -q 'Anbieter-App' "$project_dir/assets/app.js"
...
grep -q 'takemehome-shell-v14' "$project_dir/service-worker.js"
